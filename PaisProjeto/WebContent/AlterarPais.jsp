			...
			<div class="row">
			 ...
			 <div class="row">  
				 <div class="form-group col-md-6">  
					 ...
					 <input type="number" class="form-control" name="populacao" id="populcao" maxlength="20"  placeholder="População" value="${pais.populacao }"/>  
				 </div>  
				 <div class="form-group col-md-6">  
					 <label for="area">Area</label>  
					 <input type="number" class="form-control" name="area" id="area"  placeholder="Area" value="${pais.area }"/>  
				 </div>  
			 </div>   
			 <hr/>  
